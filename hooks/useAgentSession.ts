...
export function useAgentSession(opts: UseAgentSessionOptions) {
  ...
  }, [activeLeafId, addNotice, ensureNewSession, isCompacting, loadModels, loadSession, loadSlashCommands, loadTools, promoteNewSession, onSessionForked, onSessionStatsPanelOpen, onSessionTreePanelOpen]);
